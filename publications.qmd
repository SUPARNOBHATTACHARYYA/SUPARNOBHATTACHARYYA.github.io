...
<select id="pub-year"> <option value="">All Years</option> <option>2026</option> <option>2025</option> <option>2024</option> <option>2023</option> <option>2022</option> <option>2021</option> <option>2020</option> <option>2019</option> <option>2011</option> </select>
:::

## Journals

:::::: {.pub-item data-year="2026" data-type="Journal"}
[📄]{.pub-icon}

::::: pub-content
**Suparno Bhattacharyya** (2026J).\
*Computer Applications in Engineering Education*\
[A 99-Line FEM Code for Simulating a Moving Point Heat Source Over a Domain](publications/99-Line FEM.qmd)

<a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#publication-modal" data-modal-title="Cite" data-modal-content="#cite-bhattacharyya_7">Cite</a> <a href="#" class="btn btn-outline btn-sm" data-bs-toggle="modal" data-bs-target="#publication-modal" data-modal-title="Abstract" data-modal-content="#abs-bhattacharyya_7">Abstract</a> <a href="https://doi.org/10.1002/cae.70226" class="btn btn-outline btn-sm" target="_blank">URL</a>

::: {#cite-bhattacharyya_7 .d-none}
```{=html}
<pre><code>@article{Bhattacharyya2026,
  title = {A 99‐Line FEM Code for Simulating a Moving Point Heat Source Over a Domain},
  volume = {34},
  ISSN = {1099-0542},
  url = {http://dx.doi.org/10.1002/cae.70226},
  DOI = {10.1002/cae.70226},
  number = {4},
  journal = {Computer Applications in Engineering Education},
  publisher = {Wiley},
  author = {Bhattacharyya,  Suparno},
  year = {2026},
  month = July 
}</code></pre>
```
...
<a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#publication-modal" data-modal-title="Cite" data-modal-content="#cite-bhattacharyya_2">Cite</a> <a href="#" class="btn btn-outline btn-sm" data-bs-toggle="modal" data-bs-target="#publication-modal" data-modal-title="Abstract" data-modal-content="#abs-bhattacharyya_2">Abstract</a> <a href="https://link.springer.com/article/10.1007/s11831-025-10299-4" class="btn btn-outline btn-sm" target="_blank">URL</a>
